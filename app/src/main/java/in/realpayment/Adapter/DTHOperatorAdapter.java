...
public class DTHOperatorAdapter extends RecyclerView.Adapter<DTHOperatorAdapter.MyViewHolder> {
    ...
    public DTHOperatorAdapter(Context context, List<OperatorResponse> operatorResponseList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.countryName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DthRecharge.operator.setText(operatorResponseList.get(position).getOprator());
                DthRecharge.operatorId = operatorResponseList.get(position).getOpratorcode();
