...
public class PostContactAdapter extends RecyclerView.Adapter<PostContactAdapter.MyViewHolder> {
    ...
    public PostContactAdapter(Context context, List<ContactResponse> contactResponseList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView, List<ContactResponse> contactResponse) {
            super(itemView);
