package com.digi.anypayments.Activity;
...
import com.digi.anypayments.Model.OTPResponse;
import com.digi.anypayments.R;
import com.digi.anypayments.Retrofit.Api;
import com.digi.anypayments.Retrofit.ApiInterface;
import com.digi.anypayments.helper.AppSignatureHelper;
import com.digi.anypayments.interfaces.OtpReceivedInterface;
import com.digi.anypayments.receiver.SmsBroadcastReceiver;
...
public class Login extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = new File("data/data/com.digi.anypayments/shared_prefs/user.xml");
        if (file.exists()) {
    ...
    @OnClick({R.id.signUp, R.id.forgotPassword})
